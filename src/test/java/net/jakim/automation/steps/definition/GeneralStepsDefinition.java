...
public class GeneralStepsDefinition {
    ...
    public void loginPageIsOpen() throws Throwable {
        System.out.printf("just testing");
    }

    @When("^I complete login form:$")
    public void iCompleteLoginForm(DataTable dataTable) throws Throwable {
        System.out.printf("just testing");
    }

    @Then("^system let me log in successfully$")
    public void systemLetMeLogInSuccessfully() throws Throwable {
        System.out.printf("just testing");
    }

    @Given("^I'm logged in my account$")
    public void iMLoggedInMyAccount() throws Throwable {
        System.out.printf("just testing");
    }
    ...
    public void systemDestroyMySesison() throws Throwable {
        System.out.printf("just testing");
    }
}
